            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Edit {{ $backUrl }} About {{ $employee->name }}</h4>
                    </div>
                    <div class="card-body">

                        <form method="post" action="{{ route($backUrl . '.update', $employee->id) }}"
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group mb-4">
                                                <label class="form-label text-md-left ">Jabatan</label>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group mb-4">
                                                <label class="form-label text-md-left">Caption</label>
                                                <textarea class="summernote"
                                                    name="caption">{{ $employee->caption }}</textarea>
                                                @error('caption')
                                                    <span class=" text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <img id="preview-image-before-upload"
                                                src="{{ asset('images/employee/cover/' . $employee->cover) }}"

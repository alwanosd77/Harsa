            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide dark">
                    ...
                    <div class="swiper-slide-bg"
                        style="background-image: url('{{ asset('front/images/slider/swiper/1.jpg') }}');">
                    </div>
                </div>
                <div class="swiper-slide dark">
                    <div class="container">
                    ...
                    <div class="video-wrap">
                        <video poster="{{ asset('front/images/videos/deskwork.jpg') }}" preload="auto" loop autoplay
                            muted>
                            <source src='{{ asset('front/images/videos/deskwork.mp4') }}' type='video/mp4' />
                            <source src='{{ asset('front/images/videos/deskwork.webm') }}' type='video/webm' />
                        </video>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="swiper-slide-bg"
                        style="background-image: url('{{ asset('front/images/slider/swiper/3.jpg') }}'); background-position: center top;">
                    </div>
                </div>
            </div>

            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Edit {{ $backUrl }} About {{ $about->title }}</h4>
                    </div>
                    <div class="card-body">

                        <form method="post" action="{{ route($backUrl . '.update', $about->slug) }}"
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-4">
                                                <label class="form-label text-md-left ">Teks Pendek</label>
                                                <textarea class="form-control" name="shortText" style="height: 100%"
                                                    rows="3">{{ $about->shortText }}</textarea>
                                                @error('shortText')
                                                    <span class=" text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <img id="preview-image-before-upload"
                                                src="{{ asset('images/about/cover/' . $about->cover) }}"
